...
- [x] HTML entity decoding for special characters in trivia questions
- [x] Configurable timer durations (30s, 60s, 90s, 120s)
- [x] Error handling for API response codes
